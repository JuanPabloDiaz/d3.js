...
import colors from "tailwindcss/colors"; // Tremor
...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "bg-200-dark": "#1f2b3e",
        "bg-300-dark": "#374357",
        // everything below is for Tremor https://blocks.tremor.so/getting-started
        // light mode
        tremor: {
          brand: {
  ...
  plugins: [
    ...
    require("@headlessui/tailwindcss"), // Tremor
    require("@tailwindcss/forms"), // Tremor
  ],
};
